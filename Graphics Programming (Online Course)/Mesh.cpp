...
void Mesh::CreateBuffers(Vertex* vertices, int numberOfVertices, UINT* indices, int numberOfIndices, ID3D11Device* device)
{
	...
	vbd.ByteWidth = sizeof(Vertex) * numberOfVertices;       //number of vertices in the buffer
	...
	ibd.ByteWidth = sizeof(int) * numberOfIndices;         //number of indices in the buffer
...
void Mesh::CreateTerrainBuffers(Vertex* vertices, int numberOfVertices, UINT* indices, int numberOfIndices, ID3D11Device* device)
{
	// Set up the description of the static vertex buffer.
	D3D11_BUFFER_DESC vertexBufferDesc;
	vertexBufferDesc.Usage = D3D11_USAGE_DEFAULT;
	vertexBufferDesc.ByteWidth = sizeof(Vertex) * numberOfVertices;
	...
	indexBufferDesc.ByteWidth = sizeof(UINT) * numberOfIndices;
